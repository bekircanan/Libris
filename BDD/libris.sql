...
CREATE TABLE IF NOT EXISTS `abonnement` (
  ...
  `nom_abonnement` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `emprunter` (
  ...
  `date_fin_emprunt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_livre`,`id_util`,`date_debut_emprunt`),
  KEY `id_util` (`id_util`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `emprunter` (`id_livre`, `id_util`, `date_debut_emprunt`, `date_fin_emprunt`) VALUES
(2, 1, '2024-11-01 08:00:00', '2024-11-15 08:00:00'),
(2, 4, '2024-11-04 11:00:00', '2024-11-18 11:00:00'),
(2, 7, '2024-11-07 14:00:00', '2024-11-21 14:00:00'),
(2, 10, '2024-11-10 17:00:00', '2024-11-24 17:00:00'),
(3, 2, '2024-11-02 09:00:00', '2024-11-16 09:00:00'),
(3, 5, '2024-11-05 12:00:00', '2024-11-19 12:00:00'),
(3, 8, '2024-11-08 15:00:00', '2024-11-22 15:00:00'),
(4, 3, '2024-11-03 10:00:00', '2024-11-17 10:00:00'),
(4, 6, '2024-11-06 13:00:00', '2024-11-20 13:00:00'),
(4, 9, '2024-11-09 16:00:00', '2024-11-23 16:00:00');

--
-- Déclencheurs `emprunter`
--
DROP TRIGGER IF EXISTS `after_insert_emprunter`;
DELIMITER $$
CREATE TRIGGER `after_insert_emprunter` AFTER INSERT ON `emprunter` FOR EACH ROW
BEGIN
    IF (
        SELECT COUNT(*) 
        FROM emprunter
...
DROP TRIGGER IF EXISTS `after_delete_emprunter`;
DELIMITER $$
CREATE TRIGGER `after_delete_emprunter` AFTER DELETE ON `emprunter` FOR EACH ROW
BEGIN
    IF (
        SELECT COUNT(*)
        FROM emprunter
...
INSERT INTO `exemplaire` (`id_livre`, `nb_exemplaires`) VALUES
(2, 5),
(3, 6),
(4, 7);
...
CREATE TABLE IF NOT EXISTS `isbn` (
  ...
  `id_livre` int NOT NULL,
  PRIMARY KEY (`id_isbn`),
  UNIQUE KEY `uni_isbn` (`ISBN`),
  KEY `fk_isbn` (`id_livre`)
...
INSERT INTO `isbn` (`ISBN`, `id_isbn`, `id_livre`) VALUES
('9781234567890', 12, 2),
('9781234567891', 13, 3),
('9781234567892', 14, 4);
...
INSERT INTO `livre` (`id_livre`, `cote_livre`, `titre_livre`, `type_litteraire`, `img_couverture`, `resume`, `disponibilite`) VALUES
(2, 'LIV001', 'Devenir mère une maternité sans langue de bois', 'Essai', 'https://i.imgur.com/IWHmNgD.jpeg', 'Un guide sans tabou sur la maternité, abordant tous les aspects physiques, émotionnels et psychologiques de devenir mère.', 1),
(3, 'LIV002', '“Je t’avais dit de ne pas faire Koh-Lanta”', 'Essai', 'https://i.imgur.com/ttvGT0K.jpeg', 'Un récit humoristique et poignant sur l’aventure Koh-Lanta et les péripéties vécues par les participants.', 1),
(4, 'LIV003', 'L’amitié selon Aristote', 'Philosophie', 'https://i.imgur.com/b6JkX6k.jpeg', 'Une réflexion sur le concept d’amitié selon Aristote, dans le cadre de sa philosophie éthique.', 1);
...
CREATE TABLE IF NOT EXISTS `livre_edition` (
  ...
  PRIMARY KEY (`id_livre`,`id_edition`),
...
INSERT INTO `livre_edition` (`id_livre`, `id_edition`, `nb_pages`) VALUES
(2, 1, 250),
(3, 2, 300),
(4, 3, 150);
...
CREATE TABLE IF NOT EXISTS `livre_langue` (
  ...
  KEY `fk_langue` (`id_livre`) USING BTREE,
...
INSERT INTO `livre_langue` (`id_livre`, `id_langue`) VALUES
(2, 1),
(3, 1),
(4, 1);
...
CREATE TABLE IF NOT EXISTS `reserver` (
  ...
  PRIMARY KEY (`id_livre`,`id_util`,`date_reservation`),
  KEY `id_util` (`id_util`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reserver` (`id_livre`, `id_util`, `date_reservation`) VALUES
(2, 1, '2024-11-22 17:13:27'),
(4, 1, '2024-11-25 08:00:00'),
(3, 2, '2024-11-24 17:30:00'),
(2, 3, '2024-11-20 09:00:00'),
(2, 4, '2024-11-24 15:00:00'),
(3, 5, '2024-11-21 13:30:00'),
(3, 6, '2024-11-23 10:00:00'),
(4, 7, '2024-11-22 08:45:00'),
(2, 8, '2024-11-22 11:15:00'),
(2, 9, '2024-11-25 09:15:00'),
(4, 10, '2024-11-23 14:20:00');
...
ALTER TABLE `emprunter`
  ADD CONSTRAINT `emprunter_ibfk_3` FOREIGN KEY (`id_util`) REFERENCES `utilisateur` (`id_util`) ON DELETE CASCADE,
  ADD CONSTRAINT `emprunter_ibfk_4` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`) ON DELETE CASCADE;
...
--
ALTER TABLE `isbn`
  ADD CONSTRAINT `fk_isbn` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`) ON DELETE CASCADE;

--
-- Contraintes pour la table `livre_edition`
--
ALTER TABLE `livre_edition`
  ADD CONSTRAINT `livre_edition_ibfk_1` FOREIGN KEY (`id_edition`) REFERENCES `edition` (`id_edition`) ON DELETE CASCADE,
  ADD CONSTRAINT `livre_edition_ibfk_2` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`) ON DELETE CASCADE;
...
ALTER TABLE `livre_langue`
  ADD CONSTRAINT `livre_langue_ibfk_1` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`) ON DELETE CASCADE,
...
ALTER TABLE `reserver`
  ADD CONSTRAINT `reserver_ibfk_1` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`) ON DELETE CASCADE,
